...
app = Flask(__name__)  # initialising the flask app with the name 'a    pp'
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if reviews==10:
                ...
                flipkart_html = bs(flipkartPage, "html.parser") # parsing the webpage as HTML (bs is beautiful soap)
                ...
                # commentboxes = prod_html.find_all('div', {'class': "_13oc-S"}) # finding the HTML section containing the customer comments
                ...
                for commentbox in commentboxes:
                    try:
                        name = commentbox.div.div.find_all('p', {'class': '_3LYOAd _3sxSiS'})[0].text # name of the reviewer

                    except:
                        name = 'No Name'

                    try:
                        rating = commentbox.div.div.div.div.text # (Rating ex-5)

                    except:
                        rating = 'No Rating'

                    try:
                        commentHead = commentbox.div.div.div.p.text # heading of the data (ex-Must buy)
                    except:
